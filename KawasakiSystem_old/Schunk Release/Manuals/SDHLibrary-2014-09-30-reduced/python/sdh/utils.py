...
#######################################################################
## \file
#  \section sdhlibrary_python_utils_py_general General file information
#
#    \author   Russell and Norvig's 'Artificial Intelligence: A Modern Approach', see e.g. http://code.google.com/p/aima-python/source/browse/trunk/utils.py?r=27
#    \date     2006-04-07
#
#  \brief  
...
#  \internal
#
#    \subsection sdhlibrary_python_utils_py_details SVN related, detailed file specific information:
#      $LastChangedBy: Osswald2 $
#      $LastChangedDate: 2009-06-03 18:53:01 +0200 (Wed, 03 Jun 2009) $
#      \par SVN file revision:
#        $Id: utils.py 4544 2009-06-03 16:53:01Z Osswald2 $
#
#  \subsection sdhlibrary_python_utils_py_changelog Changelog of this file:
#      \include utils.py.log
#
#######################################################################
